...
class appProdProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // callback-instagram
        if ('/in-callback' === $pathinfo) {
            return array (  '_controller' => 'AppBundle\\Controller\\SecurityController::loginInstagramAction',  '_route' => 'callback-instagram',);
        }
        ...
        // edit_post
        if (0 === strpos($pathinfo, '/edit-post') && preg_match('#^/edit\\-post/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'edit_post');
            }
        ...
        // fcallback
        if ('/fb-callback' === $trimmedPathinfo) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'fcallback');
            }

            return array (  '_controller' => 'AppBundle\\Controller\\SecurityController::facebookLoginAction',  '_route' => 'fcallback',);
        }
