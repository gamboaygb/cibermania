 ...
 */
class Post_comment extends \AppBundle\Entity\Post_comment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Post_comment' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Post_comment' . "\0" . 'comment', '' . "\0" . 'AppBundle\\Entity\\Post_comment' . "\0" . 'commentDate', '' . "\0" . 'AppBundle\\Entity\\Post_comment' . "\0" . 'updateDate', '' . "\0" . 'AppBundle\\Entity\\Post_comment' . "\0" . 'commentTitle', '' . "\0" . 'AppBundle\\Entity\\Post_comment' . "\0" . 'post', '' . "\0" . 'AppBundle\\Entity\\Post_comment' . "\0" . 'person'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Post_comment $proxy) {
    ...
    public function setCommentTitle($commentTitle)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCommentTitle', [$commentTitle]);

        return parent::setCommentTitle($commentTitle);
    }
    ...
    public function getCommentTitle()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCommentTitle', []);

        return parent::getCommentTitle();
    }
