...
use AppBundle\Service\Facebook\Authentication\AccessToken;
use AppBundle\Service\Facebook\Authentication\OAuth2Client;
use AppBundle\Service\Facebook\FileUpload\FacebookFile;
use AppBundle\Service\Facebook\FileUpload\FacebookResumableUploader;
use AppBundle\Service\Facebook\FileUpload\FacebookTransferChunk;
use AppBundle\Service\Facebook\FileUpload\FacebookVideo;
use AppBundle\Service\Facebook\GraphNodes\GraphEdge;
use AppBundle\Service\Facebook\Url\UrlDetectionInterface;
use AppBundle\Service\Facebook\Url\FacebookUrlDetectionHandler;
use AppBundle\Service\Facebook\PseudoRandomString\PseudoRandomStringGeneratorFactory;
use AppBundle\Service\Facebook\PseudoRandomString\PseudoRandomStringGeneratorInterface;
use AppBundle\Service\Facebook\HttpClients\HttpClientsFactory;
use AppBundle\Service\Facebook\PersistentData\PersistentDataFactory;
use AppBundle\Service\Facebook\PersistentData\PersistentDataInterface;
use AppBundle\Service\Facebook\Helpers\FacebookCanvasHelper;
use AppBundle\Service\Facebook\Helpers\FacebookJavaScriptHelper;
use AppBundle\Service\Facebook\Helpers\FacebookPageTabHelper;
use AppBundle\Service\Facebook\Helpers\FacebookRedirectLoginHelper;
use AppBundle\Service\Facebook\Exceptions\FacebookSDKException;
