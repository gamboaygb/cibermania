...
class SecurityController extends Controller
{
    ...
    */
    public function yahooLoginAction(Request $request){
            ...
            $redirect_uri="http://".$_SERVER['SERVER_NAME'] . $this->generateUrl('callback-yahoo');
   ...
   private function twtUrl(){
    ...
    $request_token = $twitter->oauth( 'oauth/request_token', ['oauth_callback' => 'http://cibermania.es/tw-callback']);
    $session = new Session();
